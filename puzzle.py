...
class InterfaceApp:
    ...
    def __init__(self, master=None):
        ...
        self.mainlabel.configure(
            anchor="center", font="{Forte} 36 {bold}", foreground="#003e3e", justify="center", text='8-Puzzle')
        self.mainlabel.place(anchor="center", x=300, y=50)

        self.backbutton = ttk.Button(self.appFrame)
        self.img_backicon = tk.PhotoImage(file="./GUI/back-icon.png")
        ...
        self.img_nexticon = tk.PhotoImage(file="./GUI/next-icon.png")
        ...
        self.img_fastforwardicon = tk.PhotoImage(file="./GUI/fast-forward-icon.png")
        ...
        self.img_fastbackwardicon = tk.PhotoImage(file="./GUI/fast-backward-icon.png")
        ...
        self.img_stopicon = tk.PhotoImage(file="./GUI/stop.png")
        ...
        self.img_reseticon = tk.PhotoImage(file="./GUI/reset-icon.png")
        ...
        self.img_solveicon = tk.PhotoImage(file="./GUI/solve-icon.png")
        ...
        self.img_inputicon = tk.PhotoImage(file="./GUI/input-icon.png")
        ...
        self.gif = [tk.PhotoImage(file='./GUI/loading.gif', format='gif -index %i' % i) for i in range(10)]
    ...
    def showContributors(self, event=None):
        ...
        """
        messagebox.showinfo('Contributors', "19110514   -   ArusGu\n"
                                            "19110005   -   Liebe\n"
                                            "19119128   -   FoxHuman\n")
    ...
    def solveState():
        ...
        if str(algorithm) == 'BFS':
            ...
            path, cost, counter, depth, runtime = \
                main.bfs_path, main.bfs_cost, main.bfs_counter, main.bfs_depth, round(main.time_bfs, 2)
        elif str(algorithm) == 'DFS':
            main.DFS(initialState)
            path, cost, counter, depth, runtime = \
                main.dfs_path, main.dfs_cost, main.dfs_counter, main.dfs_depth, round(main.time_dfs, 2)
        elif str(algorithm) == 'A* Manhattan':
            main.AStarSearch_manhattan(initialState)
            path, cost, counter, depth, runtime = \
                main.manhattan_path, main.manhattan_cost, main.manhattan_counter, main.manhattan_depth, round(main.time_manhattan, 2)
